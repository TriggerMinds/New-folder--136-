...
class ArtifactDiscovery(Base):
    ...
    repository_pushed_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    source_added_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    source_date_evidence: Mapped[str | None] = mapped_column(Text, nullable=True)
